...
export default function Backtester() {
  ...
  return (
    <View style={styles.container}>
      <View style={{flex: 1}}>
        <CustomStatDisplay marginBottom={30} title="Balance" mainStat={formatDollarAmount(currentPrice)} subStat1={`${formatDollarAmount(pnl)} (${pnlPercent})`} subStat2={`${winCount}W / ${lossCount}L`}/>
