...
import { StyleSheet, TextInput, View, Button, InputAccessoryView, Platform, Keyboard, Pressable, Text } from 'react-native';
    ...
    return (
        <View style={[styles.rootContainer, {flex: halfWidth && 1 }]}>
            ...
            <TextInput
                ...
                returnKeyType="done"
                blurOnSubmit={true}
                inputAccessoryViewID={Platform.OS === 'ios' && keyboardType === "number-pad" ? inputAccessoryViewID : undefined}
            />
